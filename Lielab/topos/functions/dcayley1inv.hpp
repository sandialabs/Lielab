#ifndef _LIELAB_TOPOS_DCAYLEY1INV_HPP
#define _LIELAB_TOPOS_DCAYLEY1INV_HPP
...
Lielab::domain::CompositeAlgebra dcayley1inv(const Lielab::domain::CompositeAlgebra & a, const Lielab::domain::CompositeAlgebra & b)
{
    ...
    */
    ...
    for (int ii = 0; ii < a.space.size(); ii++)
    {
        ...
        {
            out.space.push_back(Lielab::functions::dcayley1inv(std::get<Lielab::domain::cn>(a.space[ii]),
        ...
        {
            out.space.push_back(Lielab::functions::dcayley1inv(std::get<Lielab::domain::glc>(a.space[ii]),

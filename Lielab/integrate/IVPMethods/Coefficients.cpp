...
std::tuple<std::array<std::array<double, COEFFICIENTS_STORAGE>, COEFFICIENTS_STORAGE>, std::array<double, COEFFICIENTS_STORAGE>, std::array<double, COEFFICIENTS_STORAGE>, std::array<double, COEFFICIENTS_STORAGE>, std::array<double, COEFFICIENTS_STORAGE>, int, int, bool, bool> get_butcher_tableau(const RungeKuttaCoefficients method)
{
    ...
    std::array<std::array<double, COEFFICIENTS_STORAGE>, COEFFICIENTS_STORAGE> A;
    std::array<double, COEFFICIENTS_STORAGE> b;
    std::array<double, COEFFICIENTS_STORAGE> bhat;
    std::array<double, COEFFICIENTS_STORAGE> c;
    std::array<double, COEFFICIENTS_STORAGE> e;

    for (int ii = 0; ii < COEFFICIENTS_STORAGE; ii++)
    {
        for (int jj = 0; jj < COEFFICIENTS_STORAGE; jj++)
        {
            A[ii][jj] = std::numeric_limits<double>::quiet_NaN();
        }

        b[ii] = std::numeric_limits<double>::quiet_NaN();
        bhat[ii] = std::numeric_limits<double>::quiet_NaN();
        c[ii] = std::numeric_limits<double>::quiet_NaN();
        e[ii] = std::numeric_limits<double>::quiet_NaN();
    }
    ...
    if (method == RungeKuttaCoefficients::FE1)
    {
        // Forward Euler
        // Source: 
    ...
    else if (method == RungeKuttaCoefficients::RK3)
    {
    ...
    else if (method == RungeKuttaCoefficients::RK4a)
    {
    ...
    else if (method == RungeKuttaCoefficients::RK4b)
    {
    ...
    else if (method == RungeKuttaCoefficients::RK5a)
    {
        ...
        A[1][0] = 1.0/5.0;
        A[2][0] = 0.0; A[2][1] = 2.0/5.0;
        A[3][0] = 9.0/4.0; A[3][1] = -5.0; A[3][2] = 15.0/4.0;
        A[4][0] = -63.0/100.0; A[4][1] = 9.0/5.0; A[4][2] = -13.0/20.0; A[4][3] = 2.0/25.0;
        A[5][0] = -6.0/25.0; A[5][1] = 4.0/5.0; A[5][2] = 2.0/15.0; A[5][3] = 8.0/75.0; A[5][4] = 0.0;
    ...
    else if (method == RungeKuttaCoefficients::RK5b)
    {
        ...
        A[3][0] = 1.0/4.0; A[3][1] = -3.0; A[3][2] = 15.0/4.0;
        A[4][0] = 2.0/27.0; A[4][1] = 10.0/9.0; A[4][2] = -50.0/81.0; A[4][3] = 8.0/81.0;
        A[5][0] = 2.0/25.0; A[5][1] = 12.0/25.0; A[5][2] = 2.0/15.0; A[5][3] = 8.0/75.0; A[5][4] = 0.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF12a)
    {
        ...
        A[1][0] = 1.0/2.0;
        A[2][0] = 1.0/256.0; A[2][1] = 255.0/256.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF12b)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKF23a)
    {
        ...
        A[1][0] = 1.0/4.0;
        A[2][0] = -189.0/800.0; A[2][1] = 729.0/800.0;
        A[3][0] = 214.0/891.0; A[3][1] = 1.0/33.0; A[3][2] = 650.0/891.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF23b)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKF34a)
    {
        ...
        A[1][0] = 1.0/4.0;
        A[2][0] = 4.0/81.0; A[2][1] = 32.0/81.0;
        A[3][0] = 57.0/98.0; A[3][1] = -432.0/343.0; A[3][2] = 1053.0/686.0;
        A[4][0] = 1.0/6.0; A[4][1] = 0.0; A[4][2] = 27.0/52.0; A[4][3] = 49.0/156.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF34b)
    {
        ...
        A[1][0] = 2.0/7.0;
        A[2][0] = 77.0/900.0; A[2][1] = 343.0/900.0;
        A[3][0] = 805.0/1444.0; A[3][1] = -77175.0/54872.0; A[3][2] = 97125.0/54872.0;
        A[4][0] = 79.0/490.0; A[4][1] = 0.0; A[4][2] = 2175.0/3626.0; A[4][3] = 2166.0/9065.0;
        ...
        bhat[0] = 229.0/1470.0;
        bhat[1] = 0.0;
        bhat[2] = 1125.0/1813.0;
        bhat[3] = 13718.0/81585.0;
        bhat[4] = 1.0/18.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF45a)
    {
        ...
        A[1][0] = 2.0/9.0;
        A[2][0] = 1.0/12.0; A[2][1] = 1.0/4.0;
        A[3][0] = 69.0/128.0; A[3][1] = -243.0/128.0; A[3][2] = 135.0/64.0;
        A[4][0] = -17.0/12.0; A[4][1] = 27.0/4.0; A[4][2] = -27.0/5.0; A[4][3] = 16.0/15.0;
        A[5][0] = 65.0/432.0; A[5][1] = -5.0/16.0; A[5][2] = 13.0/16.0; A[5][3] = 4.0/27.0; A[5][4] = 5.0/144.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF45b)
    {
        ...
        bhat[0] = 16.0/135.0;
        bhat[1] = 0.0;
        bhat[2] = 6656.0/12825.0;
        bhat[3] = 28561.0/56430.0;
        bhat[4] = -9.0/50.0;
        bhat[5] = 2.0/55.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF56)
    {
        // Fehlberg's 5(6)
        // Source: Fehlberg, Erwin. "Classical Fifth-, Sixth-, Seventh-, and Eighth-Order Runge-Kutta Formulas with Stepsize Control." NASA Technical Report R-287 (1968).
        // Table 2
    ...
    else if (method == RungeKuttaCoefficients::RKF67)
    {
        // Fehlberg's 6(7)
        // Source: Fehlberg, Erwin. "Classical Fifth-, Sixth-, Seventh-, and Eighth-Order Runge-Kutta Formulas with Stepsize Control." NASA Technical Report R-287 (1968).
        // Table 8
        ...
        A[1][0] = 2.0/33.0;
        A[2][0] = 0.0; A[2][1] = 4.0/33.0;
        A[3][0] = 1.0/22.0; A[3][1] = 0.0; A[3][2] = 3.0/22.0;
        A[4][0] = 43.0/64.0; A[4][1] = 0.0; A[4][2] = -165.0/64.0; A[4][3] = 77.0/32.0;
        A[5][0] = -2383.0/486.0; A[5][1] = 0.0; A[5][2] = 1067.0/54.0; A[5][3] = -26312.0/1701.0; A[5][4] = 2176.0/1701.0;
        A[6][0] = 10077.0/4802.0; A[6][1] = 0.0; A[6][2] = -5643.0/686.0; A[6][3] = 116259.0/16807.0; A[6][4] = -6240.0/16807.0; A[6][5] = 1053.0/2401.0;
        A[7][0] = -733.0/176.0; A[7][1] = 0.0; A[7][2] = 141.0/8.0; A[7][3] = -335763.0/23296.0; A[7][4] = 216.0/77.0; A[7][5] = -4617.0/2816.0; A[7][6] = 7203.0/9152.0;
        A[8][0] = 15.0/352.0; A[8][1] = 0.0; A[8][2] = 0.0; A[8][3] = -5445.0/46592.0; A[8][4] = 18.0/77.0; A[8][5] = -1215.0/5632.0; A[8][6] = 1029.0/18304.0; A[8][7] = 0.0;
        A[9][0] = -1833.0/352.0; A[9][1] = 0.0; A[9][2] = 141.0/8.0; A[9][3] = -51237.0/3584.0; A[9][4] = 18.0/7.0; A[9][5] = -729.0/512.0; A[9][6] = 1029.0/1408.0; A[9][7] = 0.0; A[9][8] = 1.0;

        b[0] = 77.0/1440.0;
        b[1] = 0.0;
        b[2] = 0.0;
        b[3] = 1771561.0/6289920.0;
        b[4] = 32.0/105.0;
        b[5] = 243.0/2560.0;
        b[6] = 16807.0/74880.0;
        b[7] = 11.0/270.0;
        ...
        bhat[1] = 0.0;
        bhat[2] = 0.0;
        bhat[3] = 1771561.0/6289920.0;
        bhat[4] = 32.0/105.0;
        bhat[5] = 243.0/2560.0;
        bhat[6] = 16807.0/74880.0;
        bhat[7] = 0.0;
        bhat[8] = 11.0/270.0;
        bhat[9] = 11.0/270.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF78)
    {
        // Fehlberg's 7(8)
        // Source: Fehlberg, Erwin. "Classical Fifth-, Sixth-, Seventh-, and Eighth-Order Runge-Kutta Formulas with Stepsize Control." NASA Technical Report R-287 (1968).
        // Table 10
        ...
        A[9][0] = -91.0/108.0; A[9][1] = 0.0; A[9][2] = 0.0; A[9][3] = 23.0/108.0; A[9][4] = -976.0/135.0; A[9][5] = 311.0/54.0; A[9][6] = -19.0/60.0; A[9][7] = 17.0/6.0, A[9][8] = -1.0/12.0;
    ...
    else if (method == RungeKuttaCoefficients::RKF8)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKDP54_7M)
    {
        ...
        bhat[0] = 5179.0/57600.0;
        bhat[1] = 0.0;
        bhat[2] = 7571.0/16695.0;
        bhat[3] = 393.0/640.0;
        bhat[4] = -92097.0/339200.0;
        bhat[5] = 187.0/2100.0;
        bhat[6] = 1.0/40.0;
    ...
    else if (method == RungeKuttaCoefficients::RKV65e)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV65r)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV76e)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV76r)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV87e)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV87r)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV98e)
    {
    ...
    else if (method == RungeKuttaCoefficients::RKV98r)
    {
    ...
    else if (method == RungeKuttaCoefficients::BE1)
    {
    ...
    else if (method == RungeKuttaCoefficients::LG2)
    {
        // Legendre-Gauss order 2. Also the same as implicit midpoint.
        stages = 1;
        order = 2;
        variable = false;
        implicit = true;
    ...
    else if (method == RungeKuttaCoefficients::LG4)
    {
        // 4th order Legendre-Gauss method.
        // Source: 
        ...
        A[0][0] = 1.0/4.0; A[0][1] = (3.0 - 2.0*std::sqrt(3.0))/12.0;
        A[1][0] = (3.0 + 2.0*std::sqrt(3.0))/12.0; A[1][1] = 1.0/4.0;

        b[0] = 0.5;
        b[1] = 0.5;

        c[0] = (3.0 - std::sqrt(3.0))/6.0;
        c[1] = (3.0 + std::sqrt(3.0))/6.0;
    }
    else if (method == RungeKuttaCoefficients::LG4s)
    {
        // 4th order time symmetric Legendre-Gauss method.
        // Source:
        ...
        A[0][0] = 1.0/4.0; A[0][1] = 1.0/4.0 - std::sqrt(3.0)/6.0;
        A[1][0] = 1.0/4.0 + std::sqrt(3.0)/6.0; A[1][1] = 1.0/4.0;

        b[0] = 0.5;
        b[1] = 0.5;

        c[0] = 1.0/2.0 - std::sqrt(3.0)/6.0;
        c[1] = 1.0/2.0 + std::sqrt(3.0)/6.0;
    }
    else if (method == RungeKuttaCoefficients::LG6)
    {
        // 6th order Legendre-Gauss method
        // Source:
        ...
        A[0][0] = 5.0/36.0; A[0][1] = (10.0 - 3.0*std::sqrt(15.0))/45.0; A[0][2] = (25.0 - 6.0*std::sqrt(15.0))/180.0;
        A[1][0] = (10.0 + 3.0*std::sqrt(15.0))/72.0; A[1][1] = 2.0/9.0; A[1][2] = (10.0 - 3.0*std::sqrt(15.0))/72.0;
        A[2][0] = (25.0 + 6.0*std::sqrt(15.0))/180.0; A[2][1] = (10.0 + 3.0*std::sqrt(15.0))/45.0; A[2][2] = 5/36.0;

        b[0] = 5.0/18.0;
        b[1] = 4.0/9.0;
        b[2] = 5.0/18.0;

        c[0] = (5.0 - std::sqrt(15.0))/10.0;
        c[1] = 1.0/2.0;
        c[2] = (5.0 + std::sqrt(15.0))/10.0;
    }
    else if (method == RungeKuttaCoefficients::LG6s)
    {
        // 6th order time symmetric Legendre-Gauss method
        // Source:
        ...
        A[0][0] = 5.0/36.0; A[0][1] = 2.0/9.0 - std::sqrt(15.0)/15.0; A[0][2] = 5.0/36.0 - std::sqrt(15.0)/30.0;
        A[1][0] = 5.0/36.0 + std::sqrt(15.0)/24.0; A[1][1] = 2.0/9.0; A[1][2] = 5.0/36.0 - std::sqrt(15.0)/24.0;
        A[2][0] = 5.0/36.0 + std::sqrt(15.0)/30.0; A[2][1] = 2.0/9.0 + std::sqrt(15.0)/15.0; A[2][2] = 5.0/36.0;

        b[0] = 5.0/18.0;
        b[1] = 4.0/9.0;
        b[2] = 5.0/18.0;

        c[0] = 1.0/2.0 - std::sqrt(15.0)/10.0;
        c[1] = 1.0/2.0;
        c[2] = 1.0/2.0 + std::sqrt(15.0)/10.0;
    }
    else if (method == RungeKuttaCoefficients::Lobatto3A2)
    {
        // 2nd order Lobatto 3A method. Same as the trapezoidal rule.
    ...
    else if (method == RungeKuttaCoefficients::Lobatto3A4)
    {
        // 4th order Lobatto 3A method
        // Source:
        ...
        A[1][0] = 5.0/24.0; A[1][1] = 1.0/3.0; A[1][2] = -1.0/24.0;
        A[2][0] = 1.0/6.0; A[2][1] = 2.0/3.0; A[2][2] = 1.0/6.0;
    ...
    else if (method == RungeKuttaCoefficients::Lobatto3A6)
    {
        // 6th order Lobatto 3A method
        // Source:
        ...
        A[1][0] = (11.0 + std::sqrt(5.0))/120.0; A[1][1] = (25.0 - std::sqrt(5.0))/120.0; A[1][2] = (25.0 - 13.0*std::sqrt(5.0))/120.0; A[1][3] = (-1.0 + std::sqrt(5.0))/120.0;
        A[2][0] = (11.0 - std::sqrt(5.0))/120.0; A[2][1] = (25.0 + 13.0*std::sqrt(5.0))/120.0; A[2][2] = (25.0 + std::sqrt(5.0))/120.0; A[2][3] = (-1.0 - std::sqrt(5.0))/120.0;
        A[3][0] = 1.0/12.0; A[3][1] = 5.0/12.0; A[3][2] = 5.0/12.0; A[3][3] = 1.0/12.0;
        ...
        c[0] = 0.0;
        c[1] = (5.0 - std::sqrt(5.0))/10.0;
        c[2] = (5.0 + std::sqrt(5.0))/10.0;
        c[3] = 1.0;
    }
...
{
    /*
     * Returns coefficients suitable for Crouch-Grossman methods
     *
     * @param(out) (A, b, bhat, c, e, order, stages, variable)
     */
    ...
    if (method == CrouchGrossmanCoefficients::CG23)
    {
        // Almost certainly in Ref 1, but more explicitely stated in Ref 2 Table 6.1.
        //
        // References
        // [1] Crouch, Peter E., and R. Grossman. "Numerical integration of ordinary differential equations on manifolds." Journal of Nonlinear Science 3.1 (1993): 1-33.
        // [2] Owren, Brynjulf, and Arne Marthinsen. "Runge-Kutta methods adapted to manifolds and based on rigid frames." BIT Numerical Mathematics 39.1 (1999): 116-142.
    ...
    else if (method == CrouchGrossmanCoefficients::CG4a)
    {
    ...
    else if (method == CrouchGrossmanCoefficients::CG5a)
    {

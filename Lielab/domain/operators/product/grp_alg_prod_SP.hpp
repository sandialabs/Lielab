#ifndef LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SP_HPP_
#define LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SP_HPP_
...
Lielab::domain::gl operator*(const Lielab::domain::SP & lhs, const Lielab::domain::sp & rhs)
{
    /*! \f{equation*}{ (\mathfrak{SP}, \mathfrak{sp}) \rightarrow \mathfrak{gl} \f}
    *
    * Vector product.
    */

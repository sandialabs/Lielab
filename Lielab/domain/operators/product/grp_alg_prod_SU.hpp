#ifndef LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SU_HPP_
#define LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SU_HPP_
...
Lielab::domain::glc operator*(const Lielab::domain::SU & lhs, const Lielab::domain::su & rhs)
{
    /*! \f{equation*}{ (\mathfrak{SU}, \mathfrak{su}) \rightarrow \mathfrak{glc} \f}
    *
    * Vector product.
    */

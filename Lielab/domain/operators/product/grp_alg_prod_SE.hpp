#ifndef LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SE_HPP_
#define LIELAB_DOMAIN_OPERATORS_grp_alg_prod_SE_HPP_
...
{
    /*! \f{equation*}{ (\mathfrak{SE}, \mathfrak{glc}) \rightarrow \mathfrak{glc} \f}
    *
    * Vector product.
    */
...
Lielab::domain::gl operator*(const Lielab::domain::SE & lhs, const Lielab::domain::se & rhs)
{
    /*! \f{equation*}{ (\mathfrak{SE}, \mathfrak{se}) \rightarrow \mathfrak{gl} \f}
    *
    * Vector product.
    */

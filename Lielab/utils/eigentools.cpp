...
template Eigen::VectorXi repeat<int>(const Eigen::VectorXi& vec, const int n);
template Eigen::VectorXd repeat<double>(const Eigen::VectorXd& vec, const int n);
template Eigen::VectorXi repeat<int>(std::initializer_list<int> vec, const int n);
template Eigen::VectorXd repeat<double>(std::initializer_list<double> vec, const int n);

template Eigen::VectorXi tile<int>(const Eigen::VectorXi& vec, const int n);
template Eigen::VectorXd tile<double>(const Eigen::VectorXd& vec, const int n);
template Eigen::VectorXi tile<int>(std::initializer_list<int> vec, const int n);
template Eigen::VectorXd tile<double>(std::initializer_list<double> vec, const int n);

template Eigen::VectorXd linspace<double>(const double start, const double stop, const int sz);
template Eigen::VectorXd logspace<double>(const double start, const double stop, const int sz);
...
template Eigen::MatrixXd horizontal_stack<double>(const std::vector<Eigen::MatrixXd>& mlist);
template Eigen::MatrixXd horizontal_stack<double>(std::initializer_list<Eigen::MatrixXd> mlist);

...
def test_SE_identity_initializer():
    from lielab.domain import SE
...
def test_SE_math_ops_SE():
    ...
    assert (x1_prod_x2bar.size == 6)
    assert (x1_prod_x2bar[0] == 4.75)
    assert (x1_prod_x2bar[1] == 4.5)
    assert (x1_prod_x2bar[2] == 11.25)
    assert (x1_prod_x2bar[3] == 0.0)
    assert (x1_prod_x2bar[4] == 0.0)
    assert (x1_prod_x2bar[5] == 1.0)
    ...
    assert (x1_invbar.size == 6)
    assert (np.abs(x1_invbar[0] - -3.0) <= 1e-14)
    assert (np.abs(x1_invbar[1] - -2.0) <= 1e-14)
    assert (np.abs(x1_invbar[2] - 3.0) <= 1e-14)
    assert (np.abs(x1_invbar[3] - 0.0) <= 1e-14)
    assert (np.abs(x1_invbar[4] - 0.0) <= 1e-14)
    assert (np.abs(x1_invbar[5] - 1.0) <= 1e-14)

def test_SE_project():
    from lielab.domain import SE
    import numpy as np

    rand_3_3 = np.random.uniform(size=(3,3))
    proj_3_3 = SE.project(rand_3_3).get_matrix()

    assert (proj_3_3.shape[0] == 3)
    assert (proj_3_3.shape[1] == 3)
    assert (np.abs(np.linalg.det(proj_3_3[0:2, 0:2]) - 1.0) < 1e-14)
    assert (proj_3_3[0, 2] == rand_3_3[0, 2])
    assert (proj_3_3[1, 2] == rand_3_3[1, 2])
    assert (np.abs(proj_3_3[2, 0] - 0.0) < 1e-14)
    assert (np.abs(proj_3_3[2, 1] - 0.0) < 1e-14)
    assert (np.abs(proj_3_3[2, 2] - 1.0) < 1e-14)

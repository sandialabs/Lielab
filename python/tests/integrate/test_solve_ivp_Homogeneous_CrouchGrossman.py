...
def test_solve_ivp_Homogeneous_CrouchGrossman_nan():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_inf():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_tspan_short():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_tspan_repeat():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_tspan_descending():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_topos():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_tol():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_event():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_event_tol():
    """
    ...
    assert (curve.t.size == 8)
    # assert (len(curve.y) == 3)
    assert (curve.ybar.shape[0] == 8)
    assert (curve.ybar.shape[1] == 4)
    # assert (len(curve.theta) == 3)
    assert (curve.thetabar.shape[0] == 8)
    assert (curve.thetabar.shape[1] == 4)

def test_solve_ivp_Homogeneous_CrouchGrossman_segmented():
    """
...
def test_solve_ivp_Homogeneous_CrouchGrossman_Lorenz_GLRxRN_RN():
    """

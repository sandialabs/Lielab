...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_nan", "[integrate]")
{
    /*
    ...
    */
    ...
    IVPOptions options;
    options.method = IVPMethod::CrouchGrossman;
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_inf", "[integrate]")
{
    /*
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_tspan_short", "[integrate]")
{
    /*
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_tspan_repeat", "[integrate]")
{
    /*
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_tspan_descending", "[integrate]")
{
    /*
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_topos", "[integrate]")
{
    /*
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman", "[integrate]")
{
    /*!
    ...
    */
    ...
    IVPOptions options;
    options.dt_max = 1e-2; // TODO: This shouldn't be needed but only low order variable step CG methods are available at the moment.
    options.method = IVPMethod::CrouchGrossman;
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_tol", "[integrate]")
{
    /*!
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_event", "[integrate]")
{
    /*!
    Tests solve_ivp against a classical problem with known solution.
    */
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_event_tol", "[integrate]")
{
    /*!
    ...
    */
    ...
    IVPOptions options;
    options.dt_min = 1.0; // TODO: Change this to 5.0 and curve.t.size() == from 8 to 3. This probably needs a higher order method. With dt_max = 5.0, the exit code was wrong (not triggering the event).
    options.method = IVPMethod::CrouchGrossman;
    ...
    CHECK(curve.t.size() == 8);
    // CHECK len y
    CHECK(curve.ybar.rows() == 8);
    CHECK(curve.ybar.cols() == 4);
    // CHECK len theta
    CHECK(curve.thetabar.rows() == 8);
    CHECK(curve.thetabar.cols() == 4);
}

TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_segmented", "[integrate]")
{
    /*!
...
TEST_CASE("solve_ivp_Homogeneous_CrouchGrossman_Lorenz_GLRxRN_RN", "[integrate]")
{
    /*!
    ...
    */
    ...
    IVPOptions options;
    options.method = IVPMethod::CrouchGrossman;
    options.dt_max = 1e-3; // TODO: This shouldn't be needed but only low order variable step CG methods are available at the moment.
